...
from ...models.web_authn_registration_finish_body import WebAuthnRegistrationFinishBody
...
def _get_kwargs(
    *,
    ...
    id: str,
    json_body: WebAuthnRegistrationFinishBody,
) -> Dict[str, Any]:
    url = "{}/api/auths/{id}/register/finish".format(client.base_url, id=id)
