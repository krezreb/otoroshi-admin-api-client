...
from ...models.patch_document import PatchDocument
...
def _get_kwargs(
    *,
    ...
    json_body: List[PatchDocument],
) -> Dict[str, Any]:
    url = "{}/api/globalconfig".format(client.base_url)

    headers: Dict[str, Any] = client.get_headers()
    cookies: Dict[str, Any] = client.get_cookies()

    json_json_body = []
    for componentsschemas_patch_body_item_data in json_body:
        componentsschemas_patch_body_item = componentsschemas_patch_body_item_data.to_dict()

        json_json_body.append(componentsschemas_patch_body_item)
