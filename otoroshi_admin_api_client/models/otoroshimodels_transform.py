...
from ..models.otoroshimodels_transform_settings import OtoroshimodelsTransformSettings
from ..models.otoroshimodels_transform_type import OtoroshimodelsTransformType
from ..models.otoroshimodels_verification_settings import OtoroshimodelsVerificationSettings
from ..types import UNSET, Unset

T = TypeVar("T", bound="OtoroshimodelsTransform")


@attr.s(auto_attribs=True)
class OtoroshimodelsTransform:
    """jwt token transformation policy settings"""

    transform_settings: Union[Unset, OtoroshimodelsTransformSettings] = UNSET
    algo_settings: Union[
    ...
    type: Union[Unset, OtoroshimodelsTransformType] = UNSET
    additional_properties: Dict[str, Any] = attr.ib(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        transform_settings: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.transform_settings, Unset):
            transform_settings = self.transform_settings.to_dict()
        ...
        field_dict.update({})
        if transform_settings is not UNSET:
            field_dict["transformSettings"] = transform_settings
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        _transform_settings = d.pop("transformSettings", UNSET)
        transform_settings: Union[Unset, OtoroshimodelsTransformSettings]
        if isinstance(_transform_settings, Unset):
            transform_settings = UNSET
        else:
            transform_settings = OtoroshimodelsTransformSettings.from_dict(_transform_settings)
        ...
        type: Union[Unset, OtoroshimodelsTransformType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = OtoroshimodelsTransformType(_type)

        otoroshimodels_transform = cls(
        ...
        otoroshimodels_transform.additional_properties = d
        return otoroshimodels_transform
