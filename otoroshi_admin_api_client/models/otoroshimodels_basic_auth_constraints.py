...
T = TypeVar("T", bound="OtoroshimodelsBasicAuthConstraints")


@attr.s(auto_attribs=True)
class OtoroshimodelsBasicAuthConstraints:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        otoroshimodels_basic_auth_constraints = cls(
            enabled=enabled,
            header_name=header_name,
            query_name=query_name,
        )

        otoroshimodels_basic_auth_constraints.additional_properties = d
        return otoroshimodels_basic_auth_constraints
