...
from ..models.otoroshimodels_es_algo_settings_type import OtoroshimodelsESAlgoSettingsType
from ..types import UNSET, Unset

T = TypeVar("T", bound="OtoroshimodelsESAlgoSettings")


@attr.s(auto_attribs=True)
class OtoroshimodelsESAlgoSettings:
    ...
    type: Union[Unset, OtoroshimodelsESAlgoSettingsType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, OtoroshimodelsESAlgoSettingsType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = OtoroshimodelsESAlgoSettingsType(_type)

        otoroshimodels_es_algo_settings = cls(
        ...
        otoroshimodels_es_algo_settings.additional_properties = d
        return otoroshimodels_es_algo_settings
